...
import (
	...
	"github.com/cectc/dbpack/third_party/parser/charset"
	...
	"github.com/cectc/dbpack/third_party/parser/test_driver"
)
...
func (s *testParserSuite) TestDMLStmt(c *C) {
	table := []testCase{
		...
		// for https://github.com/cectc/dbpack/third_party/parser/issues/963
...
// For issue #51
// See https://github.com/cectc/dbpack/third_party/parser/pull/51 for details
...
// See https://github.com/cectc/dbpack/third_party/parser/issue/94
...
// See https://github.com/cectc/dbpack/third_party/parser/issue/95
...
func Test(t *testing.T) {
	sql := "SELECT /*+ XID(12542533) */ * FROM T"

	sqlParser := parser.New()
	stmtNode, err := sqlParser.ParseOneStmt(sql, "", "")
	if err != nil {
	...
	assert.Equal(t, 1, len(stmt.TableHints))
	assert.Equal(t, "XID", stmt.TableHints[0].HintName.O)
	hintData := stmt.TableHints[0].HintData.(model.CIStr)
	assert.Equal(t, "12542533", hintData.String())
}
